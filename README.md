...
- [ ] Mention two parts of Express that you learned about this week.
      ANSWER: Router, express.json
- [ ] Describe Middleware?
      Middleware serves to perform specified actions/checks before the endpoint's actions are performed
- [ ] Describe a Resource?
      data
- [ ] What can the API return to help clients know if a request was successful?
      an api can return a message that confirms an action was completed.

- [ ] How can we partition our application into sub-applications?
      by using routes that are separated by category.
